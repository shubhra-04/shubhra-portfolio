    ...
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          <h1 
            data-aos="fade-up"
            className="text-white text-5xl md:text-7xl font-bold mb-4 tracking-tight"
          >
            Hi, I’m <br /> <span className="text-[#ff2a2a]"> Shubhra Dutta </span>
          </h1>
          ...
          >
             Aspiring Data Scientist & Software Developer currently pursuing B.Tech CSE (Data Science) at UPES Dehradun.
             Passionate about AI, Data Science, Web Development, Digital Marketing and building impactful solutions.
          </p>
