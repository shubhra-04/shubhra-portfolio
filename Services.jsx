...
const Services = () => {
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto relative md:h-[1800px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          ...
          <p className="text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
            A blend of Data Science, Programming, Web Development and Digital Marketing skills that I continuously improve through projects and internships.
          </p>
        </div>

        {/* Desktop SVG Animated Dashed Line */}
        <svg 
          className="hidden md:block absolute top-0 left-0 w-full h-[1800px] pointer-events-none z-0" 
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard 
            number="01"
            title="Python"
            text="Experienced with Python for problem solving, data analysis, machine learning and academic projects."
          ...
          <TagCard 
            number="02"
            title="Java & DSA"
            text="Learning Data Structures, Algorithms and Object-Oriented Programming using Java."
          ...
          <TagCard 
            number="03"
            title="Data Science"
            text="Exploring data analysis, machine learning, visualization and predictive modeling."
          ...
          <TagCard 
            ...
            text="Building responsive websites using HTML, CSS, JavaScript, React and modern web technologies."
          ...
          <TagCard 
           ...
           text="Experienced in SEO, keyword research, content marketing, social media management and digital campaign planning through internship experience."
           className="md:absolute md:top-[1300px] md:right-[10%] rotate-2 md:rotate-4"
           aosType="fade-left"
           aosDelay="500"
           pathLength={pathLength}
           containerRef={containerRef}
          ...
          <TagCard 
           ...
           text="Passionate about creating engaging social media content, reels, branding ideas and visual storytelling."
           className="md:absolute md:top-[1550px] md:left-[10%] -rotate-2 md:-rotate-4"
           aosType="fade-right"
           aosDelay="600"
           pathLength={pathLength}
           containerRef={containerRef}
